...
const CreateNotify = ({ open, onOpenChange, fetchtAllNotifyInClass }) => {
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      console.log("lectureData", notifyData, classDetails.teacher_id, classId);
      const response = await createNotify(
      ...
      toast.error("Không thể tạo thông báo mới: " + error.message);
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <DialogHeader>
          <DialogTitle>
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center dark:text-white space-x-2 text-sm text-gray-500">
