...
import { updateExamContentByExamContentId } from "@/api/ExamApi";
...
const EditExamContentPage = () => {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      setLoading(true);
      const res = await updateExamContentByExamContentId(examContentId, {
        title,
        description,
      });
      if (res.success) {
...
export default EditExamContentPage;
